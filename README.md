Here is the entire enterprise-grade `README.md` file wrapped into a single, clean code block. You can hover over the top right corner of the block, click the copy button, and paste it directly into your file inside VS Code:
